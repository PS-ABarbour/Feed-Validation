...
def country_code_validation(df):
    ...
    abspathccdf = os.path.abspath(sys.argv[0]) # changes to cwd where the script is located, reads in .xlsx, changes back to directory where file is located.
...
def lang_code_validation(df):
    ...
    abspathlcdf = os.path.abspath(sys.argv[0]) 
